...
def test_g1_conversion(camera_ids, calibration_file):
    """Test G1 direct conversion."""
    print("\n=== Testing G1 Direct Conversion ===")
    ...
    for _ in range(50):
        ...
        if mimic_obs is not None:
            ...
            if valid_conversions == 1:
                print(f"    First valid mimic_obs (35 dims):")
                print(f"      Root state: {mimic_obs[:6]}")
                print(f"      Left arm: {mimic_obs[15:22]}")
                print(f"      Right arm: {mimic_obs[22:29]}")
...
def main():
    ...
    test_g1_conversion(camera_ids, calibration_file)
